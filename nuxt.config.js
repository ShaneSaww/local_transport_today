  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og-image', property: 'og:image', content: pkg.homepageURL + '/northern_travel_tourism_show_og_image_white.png' },
      { hid: 'og-image-secure_url', property: 'og:image:secure_url', content: pkg.homepageURL + '/northern_travel_tourism_show_og_image.png' },
      ...
      { hid: 'twitter-site', name: 'twitter:site', content: '@NorthTravelShow' },
      { hid: 'twitter-image', name: 'twitter:image', content: pkg.homepageURL + '/northern_travel_tourism_show_twitter_image_white.png' },
      { hid: 'twitter-creator', name: 'twitter:creator', content: '@NorthTravelShow' },
      ...
      { hid: 'msapplication-TileColor', name: 'msapplication-TileColor', content: '#a60f28' },
