    ...
    <div role="main" class="w-full overflow-hidden flex flex-wrap justify-center pt-8">
      <div role="article" class="mt-10 mx-6 lg:mx-4 max-w-sm md:max-w-lg">
        ...
        <div class="content-text-spacing font-serif mb-4 text-left text-gray-333 leading-normal text-base md:text-xl lg:text-2xl">
          <p>Welcome to your <span class="font-serif italic opacity-75">my</span>LTT section, where you’ll find your <nuxt-link v-scroll-to="{ el: '#bookmarks', offset: -100, duration: 1000 }" to="#bookmarks" class="no-underline hover:underline focus:underline">bookmarked articles</nuxt-link>, our <nuxt-link v-scroll-to="{ el: '#rss', offset: -100, duration: 1000 }" to="#rss" class="no-underline hover:underline focus:underline">RSS feed</nuxt-link>, <nuxt-link v-scroll-to="{ el: '#dark-mode', offset: -100, duration: 1000 }" to="#dark-mode" class="no-underline hover:underline focus:underline">dark mode</nuxt-link> instructions, and your <nuxt-link v-scroll-to="{ el: '#cookie', offset: -100, duration: 1000 }" to="#cookie" class="no-underline hover:underline focus:underline">cookie settings</nuxt-link>.</p>
