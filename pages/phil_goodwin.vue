<template>
  <div>
    ...
    <div role="main" id="main" class="w-full overflow-hidden flex flex-wrap justify-center pt-8">
      <article role="article" class="mt-10 mx-6 lg:mx-4 max-w-sm md:max-w-lg">
        ...
        <div class="no-print border-t border-solid border-light-gray mt-8 py-4 flex flex-row justify-between">
          <aside role="complementary">
            ...
            <ul aria-labelledby="share-social-media-title" class="pl-0 mb-8 md:mb-0 list-none inline-block">
              ...
              <li class="block md:inline-block mb-4 md:mb-0 ml-6">
                <a class="leading-none text-sm no-underline ltt-text-pink-50 hover:ltt-text-pink focus:ltt-text-pink" target="_blank" rel="noopener noreferrer" href="#"><svg aria-hidden="true" role="img" class="fill-current h-5 w-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M23.9981 11.9991C23.9981 5.37216 18.626 0 11.9991 0C5.37216 0 0 5.37216 0 11.9991C0 17.9882 4.38789 22.9522 10.1242 23.8524V15.4676H7.07758V11.9991H10.1242V9.35553C10.1242 6.34826 11.9156 4.68714 14.6564 4.68714C15.9692 4.68714 17.3424 4.92149 17.3424 4.92149V7.87439H15.8294C14.3388 7.87439 13.8739 8.79933 13.8739 9.74824V11.9991H17.2018L16.6698 15.4676H13.8739V23.8524C19.6103 22.9522 23.9981 17.9882 23.9981 11.9991Z"/></svg><span class="pl-2 align-text-bottom font-sans font-light md:font-medium leading-normal text-base ltt-text-red no-underline hover:underline focus:underline">Like</span></a>
              </li>
              <!--<li class="block md:inline-block mb-4 md:mb-0 ml-6">
              ...
              <li class="block md:inline-block mb-4 md:mb-0 ml-6">
                <a class="leading-none text-sm no-underline ltt-text-pink-50 hover:ltt-text-pink focus:ltt-text-pink" target="_blank" rel="noopener noreferrer" href="#"><svg aria-hidden="true" role="img" class="fill-current h-5 w-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M18.813 10.259l-5.646 5.419c-.32.305-.73.458-1.141.458-.41 0-.821-.153-1.141-.458l-5.646-5.419c-.657-.628-.677-1.671-.049-2.326.63-.657 1.671-.679 2.325-.05l4.511 4.322 4.517-4.322c.66-.631 1.697-.607 2.326.049.631.645.615 1.695-.045 2.326l-.011.001zm5.083-7.546c-.299-.858-1.125-1.436-2.041-1.436H2.179c-.9 0-1.717.564-2.037 1.405-.094.25-.142.511-.142.774v7.245l.084 1.441c.348 3.277 2.047 6.142 4.682 8.139.045.036.094.07.143.105l.03.023c1.411 1.03 2.989 1.728 4.694 2.072.786.158 1.591.24 2.389.24.739 0 1.481-.067 2.209-.204.088-.029.176-.045.264-.06.023 0 .049-.015.074-.029 1.633-.36 3.148-1.036 4.508-2.025l.029-.031.135-.105c2.627-1.995 4.324-4.862 4.686-8.148L24 10.678V3.445c0-.251-.031-.5-.121-.742l.017.01z"/></svg><span class="pl-2 align-text-bottom font-sans font-light md:font-medium leading-normal text-base ltt-text-red no-underline hover:underline focus:underline">Pocket</span></a>
              </li>
            </ul>
          </aside>
          <aside role="complementary">
            ...
            <ul aria-labelledby="share-social-media-title" class="pl-0 mb-8 md:mb-0 list-none inline-block">
              <li class="block md:inline-block mb-4 md:mb-0 mr-6">
                <a class="leading-none text-sm no-underline ltt-text-pink-50 hover:ltt-text-pink focus:ltt-text-pink" href="#"><svg aria-hidden="true" role="img" class="fill-current h-5 w-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V6c0-.55.45-1 1-1h8c.55 0 1 .45 1 1v12z"/></svg><span class="pl-2 align-text-bottom font-sans font-light md:font-medium leading-normal text-base ltt-text-red no-underline hover:underline focus:underline">Bookmark</span></a>
              </li>
              <li class="block md:inline-block mb-4 md:mb-0 mr-6">
                <a class="leading-none text-sm no-underline ltt-text-pink-50 hover:ltt-text-pink focus:ltt-text-pink" href="#"><svg aria-hidden="true" role="img" class="fill-current h-5 w-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z"/></svg><span class="pl-2 align-text-bottom font-sans font-light md:font-medium leading-normal text-base ltt-text-red no-underline hover:underline focus:underline">Star</span></a>
              </li>
              <li class="block md:inline-block mb-4 md:mb-0 mr-6">
                <a class="leading-none text-sm no-underline ltt-text-pink-50 hover:ltt-text-pink focus:ltt-text-pink" href="javascript:window.print();"><svg aria-hidden="true" role="img" class="fill-current h-5 w-5" viewBox="0 0 482.5 482.5" xmlns="http://www.w3.org/2000/svg"><path d="m399.25 98.9h-12.4v-27.6c0-39.3-32-71.3-71.3-71.3h-149.7c-39.3 0-71.3 32-71.3 71.3v27.6h-11.3c-39.3 0-71.3 32-71.3 71.3v115c0 39.3 32 71.3 71.3 71.3h11.2v90.4c0 19.6 16 35.6 35.6 35.6h221.1c19.6 0 35.6-16 35.6-35.6v-90.4h12.5c39.3 0 71.3-32 71.3-71.3v-115c0-39.3-32-71.3-71.3-71.3zm-277.8-27.6c0-24.4 19.9-44.3 44.3-44.3h149.6c24.4 0 44.3 19.9 44.3 44.3v27.6h-238.2v-27.6zm238.3 375.8c0 4.7-3.9 8.6-8.6 8.6h-221.1c-4.7 0-8.6-3.9-8.6-8.6v-149.1h238.3v149.1zm83.8-161.8c0 24.4-19.9 44.3-44.3 44.3h-12.4v-31.6h17.8c7.5 0 13.5-6 13.5-13.5s-6-13.5-13.5-13.5h-330c-7.5 0-13.5 6-13.5 13.5s6 13.5 13.5 13.5h19.9v31.6h-11.3c-24.4 0-44.3-19.9-44.3-44.3v-115c0-24.4 19.9-44.3 44.3-44.3h316c24.4 0 44.3 19.9 44.3 44.3v115z"/><path d="m154.15 364.4h171.9c7.5 0 13.5-6 13.5-13.5s-6-13.5-13.5-13.5h-171.9c-7.5 0-13.5 6-13.5 13.5s6.1 13.5 13.5 13.5z"/><path d="m327.15 392.6h-172c-7.5 0-13.5 6-13.5 13.5s6 13.5 13.5 13.5h171.9c7.5 0 13.5-6 13.5-13.5s-6-13.5-13.4-13.5z"/><path d="m398.95 151.9h-27.4c-7.5 0-13.5 6-13.5 13.5s6 13.5 13.5 13.5h27.4c7.5 0 13.5-6 13.5-13.5s-6-13.5-13.5-13.5z"/></svg><span class="pl-2 align-text-bottom font-sans font-light md:font-medium leading-normal text-base ltt-text-red no-underline hover:underline focus:underline">Print</span></a>
              </li>
            </ul>
          </aside>
        </div>
      ...
      <!--<section class="mt-10 mx-4 max-w-sm lg:max-w-lg">
        <h2 class="font-sans northshow-text-red-dark mb-4 text-4xl md:text-6xl lg:mt-0">Manchester welcomes our Northern showcase</h2>
        <h3 class="font-sans font-normal northshow-text-red-dark italic mb-4 leading-tight text-xl lg:text-2xl">Come to the <em>Northern Travel &amp; Tourism Show</em> to plan your group’s future outings and itineraries.</h3>
        <div class="dropcap content-text-spacing font-serif text-black leading-normal text-base lg:text-xl">
          <p class="highlight-first-line">The <em>Northern Travel &amp; Tourism Show</em> is coming to Manchester on 25<sup>th</sup> February 2020 and will provide a unique and valuable showcase for the city itself, the whole of the North of England’s wonderful tourism attractions and destinations, plus accommodation suppliers.</p>
          <figure class="w-full flex flex-col md:shape-outside-circle md:float-right md:width-50 md:flex-row md:ml-8 md:mb-4 md:max-width-15 lg:max-width-25">
            <img class="round-image m-auto md:max-width-15 md:max-height-15 lg:max-width-25 lg:max-height-25" width="400" height="400" alt="View from St Peter’s Square, Manchester" title="View from St Peter’s Square, Manchester" src="https://assets.landortravelpublications.com/2019/10/24/5db1b14565755view_from_st_peters_sq_manchester.jpg" />
            <figcaption class="hide-moz px-8 pb-4 mt-2 font-serif northshow-text-red-light italic text-base leading-normal md:pl-4 md:pr-0 md:pb-0">View from St Peter’s Square, Manchester</figcaption>
          </figure>
          <p>We are delighted to have secured an amazing venue – the historic <em>Monastery</em> – and the support of <em>Marketing Manchester</em>, as well as the leading Manchester based tour operator, <em>Greatdays Travel Group</em>. There will also be the option of two local fam trips on the day preceding the show.</p>
          <p>From attractions to destinations, travel to accommodation, and tour operators to holiday resorts, the <em>Northern Travel &amp; Tourism Show</em> brings together all of those who are committed to making your group trips special and easier to organise. Our event will provide a focus on tourism suppliers, big and small, in Greater Manchester, Lancashire, Merseyside, Cheshire, Cumbria, Yorkshire and the North East.</p>
          <p>Come find them all at the <em>Northern Travel &amp; Tourism Show</em>!</p>
        </div>
      </section>-->
    </div>
  </div>
...
export default {
  ...
  async fetch ({ store }) {
    //await store.dispatch('event/retrieveEvent')
  },
