          ...
          <div class="cell cell--7">
            <aside role="complementary" class="author flex flex-col">
              <div v-if="author.photo" class="author-photo">
                <figure>
                  <img loading="lazy" class="notch max-w-full" :src="author.photo" :alt="author.name" :title="author.name" />
                </figure>
              </div>
              <div class="author-bio">
                <h2 class="w-full my-4 font-sans text-left font-extrabold ltt-headline leading-tight text-2xl md:text-2xl">{{ author.name }}</h2>
