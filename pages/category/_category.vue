<template>
  <div>
    <page-header :displayHero="displayHero" :pageName="categorySlug" />
  ...
  async asyncData({ params, payload }) {
    if (payload) {
      return {
        ...
        categoryEditorials: payload.categoryEditorials
      }
    }
    else {
      ...
      let category = await require(`~/assets/content/categories/${params.category}.json`)
