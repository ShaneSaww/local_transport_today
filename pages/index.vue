    ...
    <div role="main" id="main" class="w-full overflow-hidden flex flex-wrap justify-center pt-8">
      <article class="mt-10 mx-4 max-w-sm md:max-w-lg">
        ...
        <div class="dropcap content-text-spacing font-serif text-gray-333 leading-normal text-base md:text-xl">
          ...
          <aside class="ml-2 mr-2 mb-6 lg:max-width-28 lg:float-right lg:-mr-20 lg:ml-8" role="complementary">
          ...
          <figure class="mb-6 lg:max-width-28 lg:float-right lg:-mr-20 lg:ml-8 lg:mr-0">
            <img class="max-w-full border border-solid border-light-gray" src="~assets/img/map.png" alt="Map of London" title="Map of London" />
            <figcaption class="ltt-text-gray pb-2 text-base font-sans border-b border-solid border-light-gray">An overhead view of the City of London</figcaption>
          </figure>
          ...
          <aside class="ml-2 mr-2 mb-6 lg:max-width-28 lg:float-right lg:-mr-20 lg:ml-8 lg:mr-0" role="complementary">
            <blockquote class="ml-12 pl-2 ltt-text-gray font-serif italic">
