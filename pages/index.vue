      ...
      <div class="w-full mt-10 mx-6 lg:mx-4 print:mx-0">
        <aside role="complementary" class="alert-box flex flex-col lg:flex-row lg:justify-center lg:items-center w-full mt-4 lg:mt-0 mb-4">
          ...
          <div class="px-6 pb-6 lg:px-0 lg:pb-0">
            <p class="mx-auto font-sans text-center leading-tight max-width-90p lg:max-w-none text-sm lg:text-left"><a href="https://www.youtube.com/embed/dHV_GJJl9X4?autoplay=1" class="red-block flex lg:inline-flex flex-row items-center"><svg aria-hidden="true" focusable="false" class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg>
            <span>Watch Discussion</span></a></p>
          </div>
        </aside>
