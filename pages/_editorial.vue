    ...
    <div role="main" id="main" class="w-full overflow-hidden flex flex-wrap justify-center pt-8">
      <article role="article" class="mt-10 mx-6 lg:mx-4 max-w-sm md:max-w-lg">
        <aside v-if="article.categories.length > 0" role="complementary">
          ...
          <ul aria-labelledby="continue-discussion-title" class="pl-0 mb-8 md:mb-0 list-none block md:inline-block font-serif font-light md:font-medium leading-loose text-sm md:text-base">
        ...
        <aside role="complementary">
          ...
          <ul aria-labelledby="article-meta-title" class="ltt-text-gray font-serif font-light md:font-medium leading-loose text-sm md:text-base pl-0 my-6 list-none">
      ...
      <section v-if="article.allowComments && devStatus === 'production'" id="comments" class="w-full mx-6 lg:mx-4 max-w-sm md:max-w-lg border-t border-solid border-light-gray">
