    ...
    <div role="main" class="w-full overflow-hidden flex flex-wrap justify-center pt-8">
      <div role="article" class="mt-10 mx-6 lg:mx-4 max-w-sm md:max-w-lg">
        ...
        <!-- <div class="content-text-spacing font-serif mb-4 text-left text-gray-333 leading-normal text-base md:text-xl lg:text-2xl">
          <p>Welcome to your <span class="font-serif italic opacity-75">my</span>LTT section, where you’ll find your <a v-scroll-to="{ el: '#bookmarks', offset: -75, duration: 1000 }" href="#bookmarks" class="no-underline hover:underline focus:underline">bookmarked articles</a>, our <a v-scroll-to="{ el: '#rss', offset: -75, duration: 2000 }" href="#rss" class="no-underline hover:underline focus:underline">RSS feed</a>, <a v-scroll-to="{ el: '#dark-mode', offset: -75, duration: 3000 }" href="#dark-mode" class="no-underline hover:underline focus:underline">dark mode</a> instructions, and your <a v-scroll-to="{ el: '#cookie', offset: -75, duration: 4000 }" href="#cookie" class="no-underline hover:underline focus:underline">cookie settings</a>.</p>
          ...
          <p><em>Safari</em> users on both <em>iPhone</em> and <em>iPad</em> can have their bookmarks kept indefinitely by <a href="https://support.apple.com/en-gb/guide/iphone/iph42ab2f3a7/ios#iph4f9a47bbc" class="no-underline hover:underline focus:underline">adding the website to their home screen</a>.</p>
        </div> -->
        ...
        <div class="content-text-spacing font-serif mb-4 text-left text-gray-333 leading-normal text-base md:text-xl">
          <p>It’s now possible to read the entire website in dark mode, which is preferable during low light situations or for anyone who suffers from light sensitivity, and also helps to conserve your device’s battery life.</p>
          ...
          <ul role="list" class="mb-8">
            <li class="font-mono ltt-text-red"><span class="font-serif"><a href="https://www.howtogeek.com/222614/how-to-enable-windows-10s-hidden-dark-theme/" class="no-underline hover:underline focus:underline">Windows</a></span></li>
            <li class="font-mono ltt-text-red"><span class="font-serif"><a href="https://support.apple.com/en-us/HT208976" class="no-underline hover:underline focus:underline">MacOS</a></span></li>
            <li class="font-mono ltt-text-red"><span class="font-serif"><a href="https://support.apple.com/en-gb/HT210332" class="no-underline hover:underline focus:underline">iPhone, iPad or iPod</a></span></li>
            <li class="font-mono ltt-text-red"><span class="font-serif"><a href="https://support.google.com/accessibility/android/answer/6151800?hl=en-GB" class="no-underline hover:underline focus:underline">Android Devices</a></span></li>
          </ul>
        ...
        <div class="content-text-spacing font-serif mb-4 text-left text-gray-333 leading-normal text-base md:text-xl">
          ...
          <p>Cookies help our website to send anonymised data to <em>Google Analytics</em>, so that we know which articles are more popular with our audience.</p>
...
export default {
  ...
  head() {
    return {
      ...
      title: 'Settings - ' + pkg.description,
      meta: [
        { hid: 'description', name: 'description', content: 'Here you’ll find our RSS feed, dark mode instructions, and your cookie settings.' }
      ],
      link: [
        { hid: 'canonical', rel: 'canonical', href: pkg.homepageURL + '/settings/' }
      ]
    }
  }
}
